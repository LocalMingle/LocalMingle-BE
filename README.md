...
<tr>
  <td>양희용</td>
  <td>&nbsp;&nbsp;&nbsp;&nbsp;BE</td>
  <td>소셜로그인 구현(카카오,네이버,구글), 일반회원가입 구현(이메일 인증, 닉네임 중복검사),<br>실시간채팅(채팅방 생성, 유저리스트, 입장, 퇴장), 시간에 따른 채팅 이력 정리</td>
  <td><a href="https://github.com/HeeDragoN1123">양희용의<br>GitHub</a></td>
  <td><a href="https://yhy7952.tistory.com/">양희용의<br>블로그</a></td>
</tr>
<tr>
  <td>박상현</td>
  <td>Design</td>
